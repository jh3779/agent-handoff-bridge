...
| 🍎 **macOS** (Apple Silicon 전용) | **[v0.4.6 dmg](https://github.com/jh3779/agent-handoff-bridge/releases/download/v0.4.6/agent-handoff-bridge_0.4.6_aarch64.dmg)** — Intel Mac은 아직 미지원 |
