...
이 저장소는 비공개라서, 아래 모든 링크는 접근 권한이 있는 GitHub
계정으로 로그인해야 열립니다. 받는 방법은 두 가지 독립적인 경로가
...
>   "실행" 버튼이 나타납니다.
> - **macOS**: Gatekeeper가 "확인되지 않은 개발자" 경고로 막습니다.
>   Finder에서 앱을 **control+클릭 → "열기"**를 누르면 한 번만 이
>   경고를 넘길 수 있습니다.
>
