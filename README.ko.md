...
| 🍎 **macOS** (Apple Silicon 전용) | **[v0.4.9 dmg](https://github.com/jh3779/agent-handoff-bridge/releases/download/v0.4.9/agent-handoff-bridge_0.4.9_aarch64.dmg)** — Intel Mac은 아직 미지원 |
