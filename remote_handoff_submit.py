...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--auto-fallback", dest="auto_fallback", action="store_true", default=True)
    parser.add_argument("--no-auto-fallback", dest="auto_fallback", action="store_false")
