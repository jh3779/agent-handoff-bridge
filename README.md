...
| Platform | Download |
|---|---|
| 🪟 **Windows** | **[v0.4.3 인스톨러 (.exe)](https://github.com/jh3779/agent-handoff-bridge/releases/download/v0.4.3/agent-handoff-bridge_0.4.3_x64-setup.exe)** |
| 🍎 **macOS** (Apple Silicon only) | **[v0.4.3 dmg](https://github.com/jh3779/agent-handoff-bridge/releases/download/v0.4.3/agent-handoff-bridge_0.4.3_aarch64.dmg)** — Intel Mac은 아직 미지원 |
| 🐧 **Linux** | **[.AppImage](https://github.com/jh3779/agent-handoff-bridge/releases/download/v0.4.3/agent-handoff-bridge_0.4.3_amd64.AppImage)** |
