...
| Platform | Download |
|---|---|
| 🪟 **Windows** | **[v0.4.7 인스톨러 (.exe)](https://github.com/jh3779/agent-handoff-bridge/releases/download/v0.4.7/agent-handoff-bridge_0.4.7_x64-setup.exe)** |
| 🍎 **macOS** (Apple Silicon only) | **[v0.4.7 dmg](https://github.com/jh3779/agent-handoff-bridge/releases/download/v0.4.7/agent-handoff-bridge_0.4.7_aarch64.dmg)** — Intel Mac은 아직 미지원 |
| 🐧 **Linux** | **[.AppImage](https://github.com/jh3779/agent-handoff-bridge/releases/download/v0.4.7/agent-handoff-bridge_0.4.7_amd64.AppImage)** |
