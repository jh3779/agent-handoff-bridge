...
| 🍎 **macOS** (Apple Silicon only) | **[v0.3.0 dmg](https://github.com/jh3779/agent-handoff-bridge/releases/download/v0.3.0/agent-handoff-bridge_0.3.0_aarch64.dmg)** — Intel Mac은 아직 미지원 |
