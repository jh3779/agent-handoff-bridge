...
| 🍎 **macOS** (Apple Silicon only) | **[v0.4.1 dmg](https://github.com/jh3779/agent-handoff-bridge/releases/download/v0.4.1/agent-handoff-bridge_0.4.1_aarch64.dmg)** — Intel Mac은 아직 미지원 |
